...
public class E_Commerce_TC_02 extends BaseTest{
    ...
    public void fillForm() throws InterruptedException {
        ...
        String lastPageProducy = driver.findElement(By.id("com.androidsample.generalstore:id/productName")).getText();
        Assert.assertEquals(lastPageProducy,"Jordan 6 Rings");
    }
}
